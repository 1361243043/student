<?php /* Smarty version 2.6.26, created on 2013-05-29 03:04:02
         compiled from editrole.html */ ?>
<html>
<head>
...
<form action='doeditrole.php' method='post'>
    <tbody>
     <tr bgcolor="#799AE1">
        <td align="center" width="100" >角色名</td>
		<td> <input type="text" id="c_Name"name="ro_name" value="<?php echo $this->_tpl_vars['rs']['ro_name']; ?>
" maxlength="100" class="formclass"></td>
      </tr>
      <tr bgcolor="#DEE5FA">
        <td align="center" width="100">权限</td>
		<td>
...
?>
		 <?php if ($this->_tpl_vars['loop']['f_id'] == 0): ?> 
               ...
               <?php elseif (in_array ( $this->_tpl_vars['loop']['m_id'] , $this->_tpl_vars['power'] )): ?>   
...
">
	  ...
	  <tr bgcolor="#DEE5FA">
		...
		<input type="hidden" name="ro_id" value="<?php echo $this->_tpl_vars['ro_id']; ?>
">
