<?php /* Smarty version 2.6.26, created on 2013-06-13 00:51:47
         compiled from G:%5Cxampp%5Chtdocs%5Cstudent%5Ctemplate/moneyAdd.html */ ?>
<html>
<head>
    ...
    <td width="100%" colspan="5" bgcolor="#F7F7F7" align="center">
     <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#F7F7F7" bordercolor="#FFFFFF" style="font-size: 10pt">
       <tr height="35">
          ...
          <td bgcolor="#F7F7F7" align="center" background="template/template/images/title_right.gif">
            <font color="#f7f7f7">&nbsp;</font>
          </td>
       </tr>
     </table>
...
<table width="100%"  border="5" cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
	 ...
	 <tr bgcolor="#799AE1">
		...
		<td><input type="text" id="BIR" name="begin"/><img border="0"src="template/images/sel_date.gif" name="bir" style="cursor: hand"  onclick="SelectBir(3)"></td>
      </tr>
	    <tr bgcolor="#DEE5FA">
        <td align="center">收费结束时间</td>    
		<td><input type="text" id="date" name="end"/><img border="0" src="template/images/sel_date.gif" name="Date" style="cursor: hand"  onclick="SelectDate(3)"></td>
      </tr>
