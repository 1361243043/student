<?php /* Smarty version 2.6.26, created on 2013-06-18 06:39:38
         compiled from modBase.html */ ?>
<html>
<head>
    ...
    <tr>
      <td width="100%" colspan="5" bgcolor="#f7f7f7" align="center"><table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f7f7f7" bordercolor="#ffffff" style="font-size: 10pt">
          <tr height="35">
            ...
            <td width="100" bgcolor="#f7f7f7" align="center" background="template/images/title_left.gif"><font color="#f7f7f7">角色修改</font> </td>
...
<br /> 
    ...
    <tr bgcolor="#dee5fa">
      <td colspan="2" align="center"><input type="submit" name="submit" value="确认修改" onclick="return base();" />
