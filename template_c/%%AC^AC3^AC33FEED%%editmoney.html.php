<?php /* Smarty version 2.6.26, created on 2013-06-13 01:18:12
         compiled from G:%5Cxampp%5Chtdocs%5Cstudent%5Ctemplate/editmoney.html */ ?>
<html>
<head>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#F7F7F7" bordercolor="#FFFFFF" style="font-size: 10pt">
 <tr>
  ...
  <!-- 个人 -->
  <form name="form" action='editmoney.php' method='post' enctype="multipart/form-data">
...
'><?php echo $this->_tpl_vars['b']['mr_classid']; ?>
	  ...
	  <tr bgcolor="#DEE5FA">
		...
		<td id='name'><select name='name' >
 <option value='<?php echo $this->_tpl_vars['b']['s_id']; ?>
'><?php echo $this->_tpl_vars['b']['s_name']; ?>
</option>
		</select></td>
      </tr>
	  	  <tr bgcolor="#DEE5FA">
...
" /></td>
	   ...
	   <tr bgcolor="#799AE1">
		...
		<td><input type="text" name='data' id="DAT" value='<?php echo $this->_tpl_vars['b']['add_date']; ?>
'/><img border="0"src="template/images/sel_date.gif" name="btnBeginDate"style="cursor: hand"  onclick="SelectDate2(3)"></td>
      </tr>
	   <tr bgcolor="#799AE1">
...
" />
        <td colspan="2" align="center"><input name='submit' type="submit" value="确认添加" />
