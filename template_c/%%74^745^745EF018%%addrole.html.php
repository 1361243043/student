<?php /* Smarty version 2.6.26, created on 2013-05-29 02:34:46
         compiled from addrole.html */ ?>
<html>
<head>
...
<form action='doaddrole.php' method='post'>
    <tbody>
     <tr bgcolor="#799AE1">
        <td align="center" width="100" >角色名</td>
		<td> <input type="text" id="c_Name"name="ro_name" value="" maxlength="100" class="formclass"></td>
      </tr>
      <tr bgcolor="#DEE5FA">
